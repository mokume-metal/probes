...
Probe・Drift・Routine・Soak・Aftermath・Imprint・Lattice は `swift test` を回す — 赤くなったものは直った約束である。Reach は
...
def main(argv: list[str]) -> int:
    ...
    print("\n**Probe・Drift・Routine・Soak・Aftermath・Imprint・Lattice は `swift test` を回す。** 赤くなったものは直った約束なので、"
