...
let package = Package(
    ...
    products: [.executable(name: "Aftermath", targets: ["Aftermath"])],
    dependencies: [
        // 他の作品と同じく、**どの版で測ったかは Package.resolved が持つ**。版を上げて
        // 直ったものがあれば、`withKnownIssue` が「起きなかった」で赤くなって知らせる
        .package(url: "https://github.com/mokume-metal/mokume.git", from: "0.11.2")
    ],
    targets: [
        .executableTarget(
            name: "Aftermath",
        ...
        .testTarget(
            name: "AftermathTests",
            dependencies: ["Aftermath", .product(name: "mokume", package: "mokume")],
